...
class LoanApplicationsControllerTest < ActionController::TestCase
  ...
  test "should create loan_application" do
    assert_difference('LoanApplication.count') do
      post :create, loan_application: { comments: @loan_application.comments, date: @loan_application.date, loanamount: @loan_application.loanamount, loantype: @loan_application.loantype }
    end
  ...
  test "should update loan_application" do
    patch :update, id: @loan_application, loan_application: { comments: @loan_application.comments, date: @loan_application.date, loanamount: @loan_application.loanamount, loantype: @loan_application.loantype }
    assert_redirected_to loan_application_path(assigns(:loan_application))
  end
